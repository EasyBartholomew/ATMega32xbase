...
mul32s:
		...
		;***************************************************
;* Mutiply 32x32 -> 32 bit
;;  
;;  Arg 1 in lxq
;;  Arg 2 in lx
;;  return in lxq (32 bit)
;;  Need to use temp registers R31-r30-r27-r26 and
;;; R5-r4-r3-r2 also r16  (need to stack these on entry)
;;; uint32_t mul32u(uint32_t x, uint32_t y)
mul32u_tr:
        push    r2              ; save working registers
        push    r3              ; 
        push    r4
...
;;  Need to use temp registers R31-r30-r27-r26 and
;;; R5-r4-r3-r2 also r16  (need to stack these on entry)
;;; int32_t mul32s(int32_t x, int32_t y)
mul32s_tr:
        push    r2              ; save working registers
        push    r3              ; 
        push    r4
